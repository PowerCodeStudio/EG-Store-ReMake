...
void* winrt_make_EG_STORE_XamlMetaDataProvider();
...
void* __stdcall winrt_get_activation_factory([[maybe_unused]] std::wstring_view const& name)
{
    ...
    if (requal(name, L"EG_STORE.MainWindow"))
    {
        return winrt_make_EG_STORE_MainWindow();
    }

    if (requal(name, L"EG_STORE.XamlMetaDataProvider"))
    {
        return winrt_make_EG_STORE_XamlMetaDataProvider();
    }
